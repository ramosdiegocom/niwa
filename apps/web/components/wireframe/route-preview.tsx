			...
			<div className={frameClassName}>
				...
				<div className="absolute top-10 right-3 left-3 grid gap-2 sm:grid-cols-[1fr_1.35fr]">
					...
					<div className="rounded-lg border-2 border-zinc-900/65 bg-slate-950 p-2">
						<div className="mb-2 h-2 w-16 rounded-full bg-amber-300/85" />
						<div className="space-y-1.5">
							<div className="h-1.5 w-5/6 rounded-full bg-sky-300/70" />
							<div className="h-1.5 w-2/3 rounded-full bg-teal-300/70" />
							<div className="h-1.5 w-3/4 rounded-full bg-orange-300/70" />
						</div>
					</div>
				</div>
			</div>
